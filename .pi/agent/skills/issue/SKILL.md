...
This skill was installed for `issuectl 0.18.0`. On the
...
- **Older than `0.18.0`**: tell the user the skill expects
  `0.18.0` and suggest upgrading via the same channel
...
- **Newer than `0.18.0`**: the installed binary is ahead
