...
> **DRAFT — human review required before use.** Generated by `/oss-init` on 2026-08-04
> from "AI-first CLI for managing markdown-based issues with YAML frontmatter". Review each
> field, flip `status: approved`, then run `/oss-release`.
