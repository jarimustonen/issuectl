...
commits:
- hash: 01efef6
  summary: 'feat(as-flag): strip a single leading @ from --as author'
---
...
### 2026-08-14T09:48:28Z · @issuectl

Landed on main (01efef6/3a3a4a7): strip single leading @ at normalize_author seam; interior @ still rejected. Worker merged without closing; verified on main.
